...
func (s *ApiServer) LinkApple(ctx context.Context, in *api.AccountApple) (*emptypb.Empty, error) {
	...
	err := LinkApple(ctx, logger, s.db, s.config, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkFacebook(ctx context.Context, in *api.LinkFacebookRequest) (*emptypb.Empty, error) {
	...
	err := LinkFacebook(ctx, logger, s.db, s.socialClient, s.tracker, s.router, userID, username, s.config.GetSocial().FacebookLimitedLogin.AppId, in.Account.Token, in.Sync == nil || in.Sync.Value)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkFacebookInstantGame(ctx context.Context, in *api.AccountFacebookInstantGame) (*emptypb.Empty, error) {
	...
	err := LinkFacebookInstantGame(ctx, logger, s.db, s.config, s.socialClient, userID, in.SignedPlayerInfo)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkGameCenter(ctx context.Context, in *api.AccountGameCenter) (*emptypb.Empty, error) {
	...
	err := LinkGameCenter(ctx, logger, s.db, s.socialClient, userID, in.PlayerId, in.BundleId, in.TimestampSeconds, in.Salt, in.Signature, in.PublicKeyUrl)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkGoogle(ctx context.Context, in *api.AccountGoogle) (*emptypb.Empty, error) {
	...
	err := LinkGoogle(ctx, logger, s.db, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkSteam(ctx context.Context, in *api.LinkSteamRequest) (*emptypb.Empty, error) {
	...
	err := LinkSteam(ctx, logger, s.db, s.config, s.socialClient, s.tracker, s.router, userID, username, in.Account.Token, in.Sync == nil || in.Sync.Value)
	if err != nil {
		return nil, err
	}
