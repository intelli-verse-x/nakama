...
func (s *ApiServer) UnlinkApple(ctx context.Context, in *api.AccountApple) (*emptypb.Empty, error) {
	...
	err := UnlinkApple(ctx, logger, s.db, s.config, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) UnlinkFacebook(ctx context.Context, in *api.AccountFacebook) (*emptypb.Empty, error) {
	...
	err := UnlinkFacebook(ctx, logger, s.db, s.socialClient, s.config.GetSocial().FacebookLimitedLogin.AppId, userID, in.Token)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) UnlinkFacebookInstantGame(ctx context.Context, in *api.AccountFacebookInstantGame) (*emptypb.Empty, error) {
	...
	err := UnlinkFacebookInstantGame(ctx, logger, s.db, s.config, s.socialClient, userID, in.SignedPlayerInfo)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) UnlinkGameCenter(ctx context.Context, in *api.AccountGameCenter) (*emptypb.Empty, error) {
	...
	err := UnlinkGameCenter(ctx, logger, s.db, s.socialClient, userID, in.PlayerId, in.BundleId, in.TimestampSeconds, in.Salt, in.Signature, in.PublicKeyUrl)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) UnlinkGoogle(ctx context.Context, in *api.AccountGoogle) (*emptypb.Empty, error) {
	...
	err := UnlinkGoogle(ctx, logger, s.db, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) UnlinkSteam(ctx context.Context, in *api.AccountSteam) (*emptypb.Empty, error) {
	...
	err := UnlinkSteam(ctx, logger, s.db, s.config, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
